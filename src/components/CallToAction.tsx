        ...
        <div className=" pl-9 pr-4 py-16 h-full flex flex-col justify-between">
          <div>
            ...
            <p className=" text-paragrah text-fontXS font-secondaryFont font-normal mb-7">
              Lexir is always looking to connect with new exciting craft brands from around the world.
              If you have a brand in mind that you&apos;d like to see on Lexir, let us know.
            </p>
          </div>
          <div>
