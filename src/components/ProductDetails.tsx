...
import BottleImage from "../public/imgs/packshot-kiss-my-rhubarb.png";

const ProductDetails = () => {
  const [quantity, setQuantity] = useState(2);
  const [price, setPrice] = useState(230.33);
  ...
  return (
    <div className="max-w-7xl ml-8 mb-28 font-Lato">
      <div className="w-full flex flex-col sm:flex-row pr-16 sm:pr-0">
        <div className="w-full sm:w-3/5 flex justify-center items-center bg-gray-200 border border-gray-100 pt-11 pb-10 ">
          <Image src={BottleImage} alt="rhubarb liquor bottle" />
        </div>
        <div className="w-full sm:w-2/5">
          <div className="ml-0 sm:ml-20 mr-10 mt-10 sm:mt-2">
            <h2 className="font-Source font-bold text-5xl">Kiss My Rhubarb</h2>
            <p className="text-gray-400 uppercase font-bold text-xl">
              Aperitif
            </p>
            <div className="flex justify-between items-center mt-8">
              <div className="flex justify-center items-center">
                ...
                <div className="uppercase font-bold text-base ml-2">
                  Izegem, Belgium
                </div>
              </div>

              <div className="font-bold text-base">21% ABV</div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-20 gap-3 sm:gap-1">
              <div className="border border-gray-200 rounded py-3 px-20 font-normal text-base">
                700ml
              </div>
              <div className="border border-gray-200 rounded px-4 py-2 flex justify-around items-center">
                <button className="mr-3" onClick={handleQuantity}>
                  -
                </button>
                <div className="border-x py-1 px-3">{quantity}</div>
                <button className="ml-3" onClick={handleQuantity}>
                  +
                </button>
              </div>
            </div>
            <div className="w-full">
              <button className="bg-black w-full text-white flex flex-col lg:flex-row justify-between items-start sm:items-center px-10 py-3 rounded mt-3">
                <div>Add to cart</div>
                <div>${price}</div>
              </button>
            </div>
      ...
      <div className="w-full flex flex-col sm:flex-row mt-10 sm:mt-20">
        <div className="w-full sm:w-3/5 flex flex-col justify-start items-start">
          <h3 className="font-bold text-2xl">Product Details</h3>
          <p className="mt-8 text-base mr-10 sm:mr-0">
        ...
        <div className="w-full sm:w-2/5">
          <div className="ml-0 sm:ml-20 mr-10 mt-10 sm:mt-2">
            <h3 className="font-bold text-base">Tasting Notes</h3>
            ...
            <div className="flex justify-start items-center mt-7">
              <div className="flex items-center">
                ...
                >
                  <path
                    d="M12.3858 0.983643H11.6221V11.93H12.3858V0.983643Z"
                    fill="#2D2D2D"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M11.3223 0.984814C11.3223 0.819129 11.4566 0.684814 11.6223 0.684814H12.386C12.5517 0.684814 12.686 0.819129 12.686 0.984814V11.9312C12.686 12.0969 12.5517 12.2312 12.386 12.2312H11.6223C11.4566 12.2312 11.3223 12.0969 11.3223 11.9312V0.984814ZM12.386 0.984814V11.9312H11.6223V0.984814H12.386Z"
                    fill="#2D2D2D"
                  />
                  <path
                    d="M23.7176 0.60083H0.299805V1.3645H23.7176V0.60083Z"
                    fill="#2D2D2D"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0 0.600049C0 0.434363 0.134315 0.300049 0.3 0.300049H23.7178C23.8835 0.300049 24.0178 0.434363 24.0178 0.600049V1.36372C24.0178 1.5294 23.8835 1.66372 23.7178 1.66372H0.3C0.134315 1.66372 0 1.5294 0 1.36372V0.600049ZM23.7178 0.600049V1.36372H0.3V0.600049H23.7178Z"
                    fill="#2D2D2D"
                  />
                  <path
                    d="M5.45508 1.32979V14.613C5.45508 18.0641 8.39649 20.8717 12.012 20.8717C15.6275 20.8717 18.5688 18.0641 18.5688 14.613V1.32979H5.45508ZM12.012 21.6008C7.97539 21.6008 4.69141 18.466 4.69141 14.613V0.60083H19.3326V14.613C19.3326 18.466 16.0486 21.6008 12.012 21.6008Z"
                    fill="#2D2D2D"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M4.3916 0.600049C4.3916 0.434363 4.52592 0.300049 4.6916 0.300049H19.3328C19.4984 0.300049 19.6328 0.434363 19.6328 0.600049V14.6122C19.6328 18.6439 16.2012 21.9 12.0122 21.9C7.8232 21.9 4.3916 18.6439 4.3916 14.6122V0.600049ZM5.75528 1.62901V14.6122C5.75528 17.8846 8.54906 20.5709 12.0122 20.5709C15.4753 20.5709 18.269 17.8846 18.269 14.6122V1.62901H5.75528ZM5.45528 14.6122C5.45528 18.0633 8.39669 20.8709 12.0122 20.8709C15.6277 20.8709 18.569 18.0633 18.569 14.6122V1.32901H5.45528V14.6122ZM4.6916 14.6122C4.6916 18.4652 7.97558 21.6 12.0122 21.6C16.0488 21.6 19.3328 18.4652 19.3328 14.6122V0.600049H4.6916V14.6122Z"
                    fill="#2D2D2D"
                  />
                </svg>
              </div>
            ...
            <h3 className="font-bold text-base mt-7">Flavour Intensity</h3>
            ...
            <h3 className="font-bold text-base mt-7">Suggested Use</h3>
            <div className="flex flex-row sm:flex-col lg:flex-row justify-start items-center sm:items-start lg:items-center gap-2 mt-7">
              <div className="border bg-gray-100 px-4 py-2 flex items-center justify-center gap-2">
                In a cocktail
                <svg
                  width="12"
                  height="13"
