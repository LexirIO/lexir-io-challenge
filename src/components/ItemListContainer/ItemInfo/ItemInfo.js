function ItemInfo() {
  return (
    <div className="col-start-1 col-end-3 border-solid border border-slate-200 h-fit">
      <div className="p-6">
        <div className="main-title mb-12 uppercase">
          <h1 className="text-center text-[#7E143C] text-5xl font-bold mb-2">Baldoria</h1>
          <h3 className="text-[#7E143C] text-center">Vermouth</h3>
        </div>
        <div className="item-description flex flex-col">
          <h4 className="text-[black] text-center font-bold text-4xl mb-4">
            Baldoria Vermouth
          </h4>
