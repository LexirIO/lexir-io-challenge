    ...
    return (
        <div className="flex justify-center w-[1280] h-[392px] ">
            <div className="flex w-[1280px] h-[392px] mx-[33px]  ">
                <div className="flex  flex-col w-[606px] h-[392px]  ">
                    <div className="flex flex-col w-[556px] h-[216px] mt-[50px] mr-[15px] mb-[28px] ml-[34px] bg-white  ">
                        <div>
                        ...
                        <div>
                            <p className="mt-[23px]">
                                ...
                                you have a brand in mind that you'd like to see
