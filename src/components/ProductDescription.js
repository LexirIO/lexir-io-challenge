...
const ProductDescription = () => {
    return (
        <div className="flex  justify-center items-center">
            <div className=" flex  justify-center w-full h-[568px] text-black ">
                ...
                <div className=" flex flex-col items-center w-[389px] h-[440px] mt-10 mr-[35px] mb-[88px] ml-[74px] ">
                    <div className=" text-5xl font-bold">
                        <p className="text-5xl font-title pt-2.5">
                            Kiss My Rhubarb
                        </p>
                    ...
                    <div className=" w-[371px] h-[126px] mb-10   ">
                        <p>
                            ...
                            ingredients like pink grapefruit and lemon verbena
                            to create an aperitif perfectly desighned to pair
                    ...
                    <button className=" flex justify-around items-center bg-black w-[371px] h-[50px] rounded-[5px]  hover:bg-rose-300   duration-100">
